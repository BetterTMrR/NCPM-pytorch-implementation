...
def data_load(args):
    ...
    dsets["source_fu"] = ImageList_idx(args.root, txt_src, transform=image_train())
    dsets["source_fu_te"] = ImageList(args.root, txt_src, transform=image_test())
    dsets["source_tr"] = ImageList_idx(args.root, tr_txt, transform=image_train())
    dsets["source_te"] = ImageList(args.root, te_txt, transform=image_test())
    dsets["target_tr"] = ImageList_idx(args.root, txt_test, transform=image_train())
    dsets["target_te"] = ImageList(args.root, txt_test, transform=image_test())
